package com.spring.loan.CustomerServiceTest;
...
import com.spring.loan.service.CustomerServiceImpl;
...
class CustomerServiceTest {
	...
	void testSaveCustomer() {
		...
		customerInput.setPanNumber("ASADF1255G");
	...
	void testUpdateCustomer() throws CustomerNotFoundException {
		...
		customerInput.setNationality("Indian");
		customerInput.setAadharNumber("123456987654");
		customerInput.setPanNumber("CAQPT4970G");
		...
		updateCustomer.setPanNumber("CAQPT4970G");
